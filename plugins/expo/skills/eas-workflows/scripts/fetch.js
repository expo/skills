...
// import.meta.main is Bun-only until Node 24.2, so it is undefined on the Node
// 20 and 22 LTS lines this script is documented to run on. Compare the module
// URL instead, which works on every supported runtime.
