...
- See [references/testflight.md](references/testflight.md) for credential setup
- See [references/ios-app-store.md](references/ios-app-store.md) for App Store submission

### Android

- Set up Google Play Console service account
- Configure tracks: internal → closed → open → production
- See [references/play-store.md](references/play-store.md) for detailed setup

### Web

- EAS Hosting provides preview URLs for PRs
- Production deploys to your custom domain
- See [references/workflows.md](references/workflows.md) for CI/CD automation
...
See [references/workflows.md](references/workflows.md) for more workflow examples.
