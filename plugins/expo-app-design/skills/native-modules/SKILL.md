...
- Design native APIs as if you were contributing W3C specs for the browser, take inspiration from modern web modules. eg `std:kv-storage`, `clipboard`.
...
### What Makes a Module Bad

- APIs that are hard to import, e.g. `import * as MediaLibrary from 'expo-media-library';` instead of a good API like `import { MediaLibrary } from 'expo/media';`
