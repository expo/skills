...
**Turn it off:** ask your agent to "turn off Expo skills telemetry", run `plugins/expo/skills/expo-skill-feedback/scripts/telemetry.cjs --off`, or set `EXPO_SKILLS_TELEMETRY=0` / `DO_NOT_TRACK=1`.
