...
| `expo-submit-feedback` | Submit specific, actionable feedback when an Expo skill is wrong, outdated, or incomplete. |
...
Submission details live in `expo-submit-feedback`; telemetry controls live in `expo-skill-feedback`.
