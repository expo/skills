...
- **Tracked in Claude Code:** when a skill is invoked — by the AI or a user `/slash` command (`skill_invoked`, tagged with `initiator`) — and when it drives its first action (`skill_activated`).
